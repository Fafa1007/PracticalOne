...
ggplot() +
  ...
  geom_line(aes(x = as.numeric(unlist(lowess_results[1])), y = as.numeric(unlist(lowess_results[2]))), color = "blue") + # Blue line for second set of points
  ggtitle("Lowess Smoothing") +
  xlab("X Values") +
  ylab("Y Values")
```
